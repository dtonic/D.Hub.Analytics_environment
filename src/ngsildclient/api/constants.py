...
ENDPOINT_LOG = f"log"
ENDPOINT_ENTITIES = f"entities"
ENDPOINT_BATCH = f"entityOperations"
ENDPOINT_ALT_QUERY_ENTITIES = f"query"
ENDPOINT_TYPES = f"types"
ENDPOINT_CONTEXTS = f"jsonldContexts"
ENDPOINT_SUBSCRIPTIONS = f"subscriptions"
